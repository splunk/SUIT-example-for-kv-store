...
# Contributing to SUIT-example-for-kv-store
...
SuitkvStore uses [prettier](https://github.com/prettier/prettier) to ensure consistent code formatting. It is recommended
